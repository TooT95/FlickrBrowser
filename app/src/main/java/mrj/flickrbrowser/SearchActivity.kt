...
//        Log.d(TAG,".onCreateOptionsMenu: $searchableInfo")
        ...
        searchView?.setOnQueryTextListener(object: SearchView.OnQueryTextListener{
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                val sharedreference = PreferenceManager.getDefaultSharedPreferences(applicationContext)
                sharedreference.edit().putString(FLICKR_QUERY,query).apply()
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                Log.d(TAG,".onQueryTextChange: starts")
                return false
            }
        })
